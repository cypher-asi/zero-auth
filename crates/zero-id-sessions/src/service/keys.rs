...
use zero_id_crypto::derive_jwt_signing_seed;
use zero_id_identity_core::IdentityCore;
use zero_id_storage::{column_families::*, Storage};
...
impl<S: Storage, I: IdentityCore, E: EventPublisher> SessionService<S, I, E> {
    ...
    pub(super) async fn generate_signing_key(&self, epoch: u64) -> Result<JwtSigningKey> {
        ...
        let nonce = zero_id_crypto::generate_nonce()?;
        let private_key_encrypted = zero_id_crypto::encrypt_jwt_signing_key(
