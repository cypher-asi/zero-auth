...
pub enum SessionError {
    ...
    StorageError(#[from] zero_id_storage::StorageError),

    #[error("Identity core error: {0}")]
    IdentityCoreError(#[from] zero_id_identity_core::IdentityCoreError),

    #[error("Crypto error: {0}")]
    CryptoError(#[from] zero_id_crypto::CryptoError),
