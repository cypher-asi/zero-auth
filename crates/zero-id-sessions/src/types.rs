...
///
/// Extends standard OAuth2 introspection with zero-id specific claims
#[derive(Debug, Clone, Serialize, Deserialize)]
...
// Re-export current_timestamp from zero-id-crypto
pub use zero_id_crypto::current_timestamp;
