...
use uuid::Uuid;
use zid_identity_core::{IdentityCore, IdentityCoreService};
...
#[async_trait]
impl zid_identity_core::EventPublisher for MockIdentityCoreEventPublisher {
    async fn publish(
        &self,
...
pub async fn create_test_identity_with_machine(
    ...
    let machine_key = MachineKey {
        ...
        capabilities: zid_crypto::MachineKeyCapabilities::FULL_DEVICE,
        epoch: 1,
        created_at: now,
        expires_at: None,
        last_used_at: None,
