...
use tracing::info;
use uuid::Uuid;
use zero_id_crypto::MachineKeyCapabilities;
use zero_id_crypto::{current_timestamp, hkdf_derive_32};
use zero_id_identity_core::{IdentityCore, MachineKey};
use zero_id_policy::{Operation, PolicyEngine};
    ...
    S: Storage,
{
    ...
    fn derive_virtual_machine_keys(&self, identity_id: Uuid) -> Result<(Uuid, [u8; 32], [u8; 32])> {
        use zero_id_crypto::{hkdf_derive_32, Ed25519KeyPair, X25519KeyPair};
