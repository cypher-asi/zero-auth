...
pub enum AuthMethodsError {
    ...
    IdentityCore(#[from] zero_id_identity_core::IdentityCoreError),

    /// Storage error
    #[error("Storage error: {0}")]
    Storage(#[from] zero_id_storage::StorageError),

    /// Crypto error
    #[error("Crypto error: {0}")]
    Crypto(#[from] zero_id_crypto::CryptoError),

    /// Policy error
    #[error("Policy error: {0}")]
    Policy(#[from] zero_id_policy::PolicyError),
