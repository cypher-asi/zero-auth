...
use tracing::info;
use uuid::Uuid;
use zero_id_crypto::{canonicalize_enrollment_message, verify_signature};
    ...
    S: Storage + 'static,
{
    ...
    pub(crate) async fn enroll_machine_key_internal(
        ...
        let policy_context = zero_id_policy::PolicyContext {
            ...
            mfa_verified,
            operation: zero_id_policy::Operation::EnrollMachine,
            resource: Some(zero_id_policy::Resource::Machine(machine_key.machine_id)),
            ip_address,
            user_agent,
