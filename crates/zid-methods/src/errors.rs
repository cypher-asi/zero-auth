...
pub enum AuthMethodsError {
    ...
    IdentityCore(#[from] zid_identity_core::IdentityCoreError),

    /// Storage error
    #[error("Storage error: {0}")]
    Storage(#[from] zid_storage::StorageError),

    /// Crypto error
    #[error("Crypto error: {0}")]
    Crypto(#[from] zid_crypto::CryptoError),

    /// Policy error
    #[error("Policy error: {0}")]
    Policy(#[from] zid_policy::PolicyError),
