...
/// Derive Managed Identity Signing Keypair (server-side, PQ-Hybrid)
...
/// High-level: Derive complete PQ-Hybrid Machine Key pair
...
stateDiagram-v2
    ...
    MlDsaCreated --> MachineKeyPairReady
    MlKemCreated --> MachineKeyPairReady
